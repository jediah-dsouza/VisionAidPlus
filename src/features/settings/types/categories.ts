...
export type PreferenceValue<K extends PreferenceCategory> =
  UserPreferences[K][keyof UserPreferences[K]];
...
export const SETTINGS_CATEGORIES: SettingCategoryDefinition[] = [
    ...
    fields: [
      {
        ...
        label: 'Screen Reader',
        description: 'Enable TalkBack / VoiceOver support',
        type: 'toggle',
      },
      {
      ...
      },
      {
        ...
        description: 'Spoken feedback for events',
        type: 'toggle',
      },
      {
        key: 'focusIndicator',
        ...
        description: 'Show focus highlight',
        type: 'toggle',
      },
      {
        ...
        category: 'accessibility',
        label: 'Quiet Hours',
        description: 'Silence announcements during set hours',
        type: 'toggle',
      },
      {
        key: 'quietHoursStart',
        ...
        type: 'time',
        dependsOn: { category: 'accessibility', key: 'quietHoursEnabled', value: true },
      },
      {
        key: 'quietHoursEnd',
        category: 'accessibility',
  ...
  },
  {
    ...
    icon: '',
    description: 'Text-to-speech, volume, language preferences',
    fields: [
      {
        key: 'ttsEnabled',
        category: 'audio',
      ...
      },
      {
        ...
        category: 'audio',
        label: 'Volume',
        description: 'Voice output volume',
        type: 'slider',
        min: 0,
        max: 1.0,
        step: 0.1,
      },
      {
        ...
        category: 'audio',
        label: 'TTS Language',
        description: 'Language for voice output',
        type: 'select',
        options: ['en-US', 'es-ES', 'fr-FR', 'de-DE', 'zh-CN', 'ar-SA'],
      },
      {
        key: 'audioOutput',
        category: 'audio',
        ...
        type: 'select',
        options: ['speaker', 'bluetooth', 'wired'],
      },
      {
        key: 'soundEffects',
        category: 'audio',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description: 'Vibrate on screen touch',
        type: 'toggle',
      },
      {
        key: 'hapticOnNotification',
        category: 'haptic',
  ...
  },
  {
    ...
    fields: [
      {
        key: 'navigationSensitivity',
        category: 'navigation',
        label: 'Sensitivity',
        description: 'Obstacle detection range (1-5)',
        type: 'slider',
        min: 1,
        max: 5,
        step: 1,
      ...
      {
        key: 'obstacleAlertDistance',
        category: 'navigation',
        label: 'Alert Distance',
        description: 'Distance threshold for obstacle alerts',
        type: 'select',
        options: ['near', 'medium', 'far'],
      },
      {
        key: 'voiceGuidanceFrequency',
        category: 'navigation',
        label: 'Voice Guidance',
        description: 'How often voice guidance is given',
        type: 'select',
        options: ['frequent', 'normal', 'minimal'],
      },
      {
        key: 'autoReroute',
        category: 'navigation',
        label: 'Auto Reroute',
        description: 'Automatically recalculate route',
        type: 'toggle',
      },
      {
        key: 'landmarkAnnouncements',
        category: 'navigation',
        label: 'Landmarks',
        description: 'Announce nearby landmarks',
        type: 'toggle',
      },
    ],
  },
